...
def showGameState( gameState, playerTurn, gameStage, playedTurns, gameBoardGraphics ):
	print()
	...
	gameBoardGraphics.bar3d( playerXpos, playerYpos, playerZpos, playerD, playerD, playerD, color='#aa0033' )
	plt.draw()
